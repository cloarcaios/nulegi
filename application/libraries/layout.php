...
class Layout {
    ...
    private $contratos_generados = '';
    private $contratos_compartidos = '';
    private $classpage = '';
    private $page = '';
    private $page_url = '#';
    ...
    function view($view, $data = null, $return = false) {        
        ...
        $this->datapage['headerpage']['contratos_generados'] = $this->contratos_generados;
        $this->datapage['headerpage']['contratos_compartidos'] = $this->contratos_compartidos;
    ...
    function contratos_generados($contratos_generados) { $this->contratos_generados = $contratos_generados; }
    function contratos_compartidos($contratos_compartidos) { $this->contratos_compartidos = $contratos_compartidos; }
}